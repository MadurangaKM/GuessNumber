...
const GameOverScreen = (props) => {
  ...
  const styles = StyleSheet.create({
    ...
    image: {
      marginTop: screenData.isLandscape?screenData.screen.height/10:screenData.screen.height/20,
      width: "80%",
      height:screenData.isLandscape?screenData.screen.height/2: screenData.screen.height/4,
    },
  });
  console.log("Check Screen Orientation Game Over",screenData.isLandscape)
  return (
